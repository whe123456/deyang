...
if($id!=''){
    ...
    $arr=array($form['sjhm'],$form['xm'],$now,'0','','',$form['bjbm'],$xh,$form['bj_mc'],$js_bh,$grade,$id);
    $msg='白名单信息修改成功';
    ...
    $msg='白名单信息增加成功';
    Database::InsertOrUpdate($sql,$conn,array($form['sjhm'],$form['xm'],$now,$now,'0','','',$form['bjbm'],$xh,$form['bj_mc'],$js_bh,$grade));
}
